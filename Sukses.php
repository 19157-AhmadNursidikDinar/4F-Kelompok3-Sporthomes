	...
	<body>
		<div class="wrapper">
			...
			<section class="courses">
				<article>
						<h2 align="center"><br><br>Terima Kasih Atas Kepercayaan Anda <br><br> Melakukan Pembelian Di Toko Kami<br><br></h2>
						<h1 align="center">Kami telah mengirim rincian Pesananmu Melalui Whatsapp<br>selesaikan pembayaran maksimal 1x24Jam</h1>
				</article>
			</section>
			<footer>
				&copy; 2021 Dinar
