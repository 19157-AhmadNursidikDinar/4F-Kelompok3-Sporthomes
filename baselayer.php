...
<html>
			...
			<header>
				...
				<nav>
					<ul>
						...
						<li><a href="baselayer.php" class="current">Baselayer</a></li>
	...
	<?php
	$i=0;
	$query = mysql_query("SELECT * FROM baselayer");
	...
	?>
			<tr>
				...
				<td><p align="center"><b><?php echo $data['Nama']; ?></b></p><br>
					...
					Warna : <?php echo $data['Warna']; ?><br>
					SPESIFIKASI :<br>
					<?php echo $data['Desc']; ?><br><br>
					<a href="UserBeliBaselayer.php?Nama=<?php echo $data['Nama']; ?>"><input type="submit" class="btn" value="Beli"></a></td>
			</tr>
	<?php } ?>
	</table>
			<footer>
