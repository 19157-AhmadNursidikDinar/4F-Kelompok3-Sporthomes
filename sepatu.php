...
<html>
	...
	<body>
		<div class="wrapper">
			<header>
				...
				<nav>
					<ul>
						<li><a href="sepatu.php" class="current">Sepatu</a></li>
	...
	<?php
	$i=0;
	$query = mysql_query("SELECT * FROM sepatu");
	...
	?>
			<tr>
				...
				<td><p align="center"><b><?php echo $data['Nama']; ?></b></p><br>
					...
					<a href="UserBeliSepatu.php?Nama=<?php echo $data['Nama']; ?>"><input type="submit" class="btn" value="Beli"></a></td>
			</tr>
	<?php } ?>
	</table>
			<footer>
