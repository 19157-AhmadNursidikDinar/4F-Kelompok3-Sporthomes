...
<html>
			...
			<header>
				...
				<nav>
					<ul>
						...
						<li><a href="aksesoris.php" class="current">Aksesoris</a></li>
					</ul>
				</nav>
			</header>
		</table>	
	...
	<?php
	$i=0;
	$query = mysql_query("SELECT * FROM aksesoris");
	...
	?>
			<tr>
				...
				<td><p align="center"><b><?php echo $data['Nama']; ?></b></p><br>
					...
					<a href="UserBeliAksesoris.php?Nama=<?php echo $data['Nama']; ?>"><input type="submit" class="btn" value="Beli"></a></td>
			</tr>
	<?php } ?>
	</table>
			<footer>
