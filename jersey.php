...
<html>
			...
			<header>
				...
				<nav>
					<ul>
						...
						<li><a href="jersey.php" class="current">Jersey</a></li>
	...
	<?php
	$i=0;
	$query = mysql_query("SELECT * FROM jersey");
	...
	?>
			<tr>
				...
				<td><p align="center"><b><?php echo $data['Nama']; ?></b></p><br>
					...
					<a href="UserBeliJersey.php?Nama=<?php echo $data['Nama']; ?>"><input type="submit" class="btn" value="Beli"></a></td>
			</tr>
	<?php } ?>
	</table>
			<footer>
